...
class DagmanCreator(TaskAction):
    ...
    def createSubdag(self, splitterResult, **kwargs):
        ...
        with open("RunJobs.dag.config", "w", encoding='utf-8') as cfg:
            cfg.write("# Automatically generated by DagmanCreator\n")
            cfg.write("DAGMAN_RESET_RETRIES_UPON_RESCUE = True\n")
            cfg.write("DAGMAN_RETRY_SUBMIT_FIRST       = True\n")
            cfg.write("DAGMAN_WRITE_PARTIAL_RESCUE     = True\n")
            cfg.write(f"DAGMAN_DEFAULT_RETRY            = {self.task['numautomjobretries']} \n")
    ...
    def executeInternal(self, *args, **kw):
        ...
        # files to be transferred to remote WN's via Job.submit. Add to the "code" tarball files created by TW
        ...
        filesForSched = ['CMSRunAnalysis.tar.gz', 'TaskManagerRun.tar.gz', 'RunJobs.dag.config']
